...
- `LearnView`: renders course capacity honestly, opens authored lessons, transitions between bounded cards, and returns to the course map without writing mastery.
...
- Developer diagnostics require `LINGUISTICS_DEVELOPER_MODE=1` and keep learner language and provider bodies out of inspection.
...
Paper design system v2 Phase 1 on 2026-08-30. Light/dark and reduced-motion visual evidence covers onboarding, shell, Today, Progress, Settings, and the raster-cutout PaperStage sandbox. Current keyboard and VoiceOver interaction remains named unverified because this macOS process does not have Accessibility control permission; Windows native interaction also remains unavailable.
