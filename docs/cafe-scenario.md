...
On success, schema 3 atomically stores a concept attempt, task attempt, target-concept progression decision, and review handoff. The record includes content/evaluation/schema versions, model realization mode, encountered error-rule IDs, and any confirmed multilingual bridge reference. It excludes raw learner and server messages.
